...
namespace AUTO_Matic
{
    ...
    {
        public static bool TouchTopOf(this Rectangle r1, Rectangle r2, bool isPilot = false)
        {
        ...
        public static bool TouchBottomOf(this Rectangle r1, Rectangle r2, bool isPilot = false)
        {
            if(isPilot)
            {
